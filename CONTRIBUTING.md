...
**1.** Fork [this](https://github.com/firtysh/mlody) repository.
...
**8.** Create a [PR](https://github.com/firtysh/mlody) .

### 🔑Guidelines

Here are some set of guidelines to follow while contributing to `mlody` :
